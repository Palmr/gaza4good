<div class="requestsTags index">
	<h2><?php echo __('Requests Tags'); ?></h2>
	...
	<?php
	foreach ($requestsTags as $requestsTag): ?>
	<tr>
		<td>
		...
		<td><?php echo h($requestsTag['RequestsTag']['id']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $requestsTag['RequestsTag']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $requestsTag['RequestsTag']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $requestsTag['RequestsTag']['id']), null, __('Are you sure you want to delete # %s?', $requestsTag['RequestsTag']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
